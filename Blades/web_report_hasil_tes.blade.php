...
<div class="print-container">
  ...
  <table class="main-table" width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td style="width: 44%; text-align: center; vertical-align: middle; padding: 14px 8px; font-size: 12pt; font-weight: bold; border-right: 1px solid #000; border-bottom: 1px solid #000; letter-spacing: 0.5px;">
      ...
      <td style="width: 30%; vertical-align: middle; padding: 10px 14px; border-bottom: 1px solid #000;">
        <table style="width: 100%; border: none; border-collapse: collapse;" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td style="border: none; padding: 3px 0; font-weight: bold; font-size: 9.5pt;">FM-HRD-REC-002</td>
          </tr>
          <tr>
            <td style="width: 65px; border: none; padding: 3px 0; font-size: 9.5pt;">No. Urut</td>
            <td style="width: 10px; border: none; padding: 3px 0; font-size: 9.5pt;">:</td>
            <td style="border: none; padding: 3px 0; font-weight: bold; font-size: 9.5pt; white-space: nowrap;">{{ $data->nomor ?? '-' }}</td>
          </tr>
        </table>
      </td>
    </tr>
