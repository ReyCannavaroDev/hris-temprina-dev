...
<div class="flex flex-col border rounded-md shadow-md md:w-full w-full p-0 bg-white border-none">
  ...
  disabled: !actionText}" class="w-full !mt-3" :value="values.m_subcomp_id" @input="v => {
    ...
    <!-- CABANG -->
    <div>
      <FieldSelect :bind="{ disabled: !actionText }" class="w-full !mt-3" :value="values.m_branch_id" @input="v => {
    if (v) {
    ...
    <div>
      <FieldSelect :bind="{ disabled: !actionText  }" class="w-full mt-3" :value="values.m_divisi_id"
