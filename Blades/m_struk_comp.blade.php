...
<div>
  <!-- Header Section -->
  <header
    class="h-24 flex items-center justify-center bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-lg rounded-t-lg">
    <div class="text-center">
      <h1 class="text-3xl font-bold">STRUKTUR COMPANY TEMPRINA</h1>
    </div>
  </header>
  ...
  >
    ...
    <div class="w-full max-w-2xl mb-8 p-4 bg-white rounded-xl shadow-md transition-all duration-300 hover:shadow-lg">
      <!-- Instruction Label -->
      <div class="mb-3">
        <span class="text-gray-700 font-medium text-sm">Pilih Data Berdasarkan SBU</span>
      </div>
