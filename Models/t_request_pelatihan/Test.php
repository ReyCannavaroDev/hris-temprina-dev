...
class tRequestPelatihanTest extends TestCase
{
    ...
    public function testReadingData()
    {
        ...
        $this->call('GET', '/operation/t_request_pelatihan', $payload);
    ...
    public function testCreatingData()
    {
        ...
        $this->call('POST', '/operation/t_request_pelatihan', $payload);
        ...
        $this->seeInDatabase('t_request_pelatihan', array_filter($payload, function($dt){
            return !is_array($dt);
        } ));
    }
}