...
{   
    ...
    public $details     = [];
    public $heirs       = ["m_tunj_kemahalan","t_final_gaji_det","t_perhitungan_gaji","m_kary","m_lembur","m_spd","m_standart_gaji","t_grup_kerja","t_jadwal_kerja","t_jadwal_kerja_det","t_spd"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
