...
class mRoleTest extends TestCase
{
    ...
    public function testReadingData()
    {
        ...
        $this->call('GET', '/operation/m_role', $payload);
    ...
    public function testCreatingData()
    {
        ...
        $payload = [
		    ...
		    "m_role_det" => [
		        [
		            "id" => "bigint:optional:autocreate",
		            "m_role_id" => "bigint:optional:autocreate",
		            "m_comp_id" => "bigint:optional",
		            "m_dir_id" => "bigint:optional",
        ...
        $this->call('POST', '/operation/m_role', $payload);
        ...
        $this->seeInDatabase('m_role', array_filter($payload, function($dt){
            return !is_array($dt);
        } ));
    }
}