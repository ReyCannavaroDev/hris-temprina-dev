...
class generateapproval extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->bigInteger('last_action_id')->comment('{"src":"default_users.id"}')->nullable();
            $table->bigInteger('next_approve_det_id')->comment('{"src":"generate_approval_det.id"}')->nullable();
