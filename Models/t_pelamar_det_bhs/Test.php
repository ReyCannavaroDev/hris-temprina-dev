...
class tPelamarDetBhsTest extends TestCase
{
    ...
    public function testReadingData()
    {
        ...
        $this->call('GET', '/operation/t_pelamar_det_bhs', $payload);
    ...
    public function testCreatingData()
    {
        ...
        $this->call('POST', '/operation/t_pelamar_det_bhs', $payload);
        ...
        $this->seeInDatabase('t_pelamar_det_bhs', array_filter($payload, function($dt){
            return !is_array($dt);
        } ));
    }
}